...
import iconMinus from '../../img/icons/icon-minus.png'
import iconPlus from '../../img/icons/icon-plus.png'
...
function TextSize(props) {
  ...
  const handleChange = e => {
    ...
    newCoords = getNewCoords(layerId, coords, rotateAngle, () => applyFontSize(value))
    setValue(value)
